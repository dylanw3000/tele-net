...
void main()
{
    ...
    */
    ...
    float ang3 = atan(yy+sin(u_fAng)*u_vSize.x/2.0,xx+cos(u_fAng)*u_vSize.x/2.0) + pi/2.0;
    float ang4 = atan(yy-sin(u_fAng)*u_vSize.x/2.0,xx-cos(u_fAng)*u_vSize.x/2.0) + pi/2.0;
